 ...
 */
@Entity
@Table(name = "users", catalog = "dblemon", schema = "", uniqueConstraints = {
...
public class Users implements Serializable {
    ...
    public Users(Integer id, String firstName, String lastName, String dni, String email, String password) {
        this.id = id;
